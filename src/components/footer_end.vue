<template>
     <div class="footer pt-5 pb-5 text-center">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-lg-4">
                     <div class="info">
                        <img class="mb-4 mt-1" width="100px" height="100px" src="../assets/274353054_5095796437109710_5311856712517554349_n.jpg" alt="">
                        <p class="mb-4">
                         ...
                         <div class="copyright">
                            ...
                            <div>&copy;2022-2023<span> lbezz</span></div>
                         </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-2">
                    <div class="links">
                        <h5 class="text-warning mb-4 mt-4">Links</h5>
                ...
                <div class="col-md-6 col-lg-2">
                    <h5 class="text-warning mt-4 mb-4 1h-lg">About Us</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="contact">
                        <h5 class="text-warning mt-4">Contact Us</h5>
                        <p class="1h-lg mt-3 mb-2">Get in touch with us via mail phone.we are waiting for your call or message</p>
